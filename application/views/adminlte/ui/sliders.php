<!-- bootstrap slider -->
<link rel="stylesheet" href="<?php echo $url->assets ?>plugins/bootstrap-slider/slider.css">
...
<!-- Bootstrap slider -->
<script src="<?php echo $url->assets ?>plugins/bootstrap-slider/bootstrap-slider.js"></script>
<script>
  $(function () {
    /* BOOTSTRAP SLIDER */
    $('.slider').slider()
