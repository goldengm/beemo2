    ...
    <nav class="navbar navbar-static-top">
      <div class="container">
        <div class="navbar-header">
          <a href="<?php echo $url->assets ?>index2.html" class="navbar-brand"><b>Admin</b>LTE</a>
          ...
          <ul class="nav navbar-nav">
                  ...
                  <ul class="menu">
                    <li><!-- start message -->
                      <a href="#">
                        <div class="pull-left">
                          <!-- User Image -->
                          <img src="<?php echo $url->assets ?>img/user2-160x160.jpg" class="img-circle" alt="User Image">
                        </div>
            ...
            <li class="dropdown user user-menu">
              ...
              <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                ...
                <img src="<?php echo $url->assets ?>img/user2-160x160.jpg" class="user-image" alt="User Image">
